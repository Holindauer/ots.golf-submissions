...
/-! A flat forest OTS with an equivalent RV64IM verifier, at most 696 cycles on every execution. -/
...
refinement on every input, and at most 696 cycles on every execution. -/
theorem certificate : submission.Certificate 696 := RiscvUpperForest.machineCertificate
